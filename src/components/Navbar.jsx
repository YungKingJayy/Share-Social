...
export default function Navbar({ searchTerm, setSearchTerm, user }) {
    ...
    return (
        <div className="flex gap-2 md:gap-5 w-full mt-5 pb-7">
            <div className="flex justify-start items-center w-full px-2 rounded-full bg-white border-none outline-none focus-within:shadow-lg">
            ...
            <div className="flex gap-3">
                <Link to={`user-profile/${user?._id}`} className="hidden md:block rounded-full">
