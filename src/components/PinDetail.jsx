...
export default function PinDetail ( {user} ) {
    ...
    return (
        <>
            <div
                className="flex xl:flex-row flex-col m-auto bg-white shadow-lg rounded-[32px]"
                style={{ maxWidth: "1500px"}}
            >
                <div className="flex justify-center items-center md:items-start flex-initial">
                    <img
                        src={pinDetail?.image && urlFor(pinDetail.image).url()}
                        className="rounded-t-[32px] rounded-b-none xl:rounded-tr-none xl:rounded-br-none xl:rounded-bl-[32px]  w-full h-full"
                        alt="user-post"
                    />
                </div>
                <div className="w-full p-5 flex-1 xl:min-w-620">
                    ...
                    <div className="flex flex-wrap mt-6 gap-3 items-center">
                        ...
                        <input
                            className="flex-1 border-gray-100 outline-none border-2 p-2 rounded-full focus:border-gray-300"
                            type="text"
